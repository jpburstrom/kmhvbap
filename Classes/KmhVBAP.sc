	...
	*initClass {
	...
	[ -45 , 69.185799 ], [ 45 , 69.185799 ], [ 135 , 69.185799 ], [ -135 , 69.185799 ], [ 0 , 90 ]],
			...
			kmh114: IdentityDictionary[
				2 -> [24.6, 0, -26.34, -58.7, -106, -129.35, 129.35, 106, 58.7],
				3 ->  [ [ 24.6, 0.0 ], [ 0, 0 ], [ -26.34, -0.0 ], [ -58.7, -0.0 ], [ -106, 0 ], [ -129.35, -0.0 ], [ 129.35, 0.0 ], [ 106, 0 ], [ 58.7, 0.0 ], [ 45, 18 ], [ -45, 18 ], [ -135, 18 ], [ 135, 18 ], [ 0, 90 ] ],
				//Array index = VBAP channel
				//Number = Output channel
				\channelMap -> [0, 2, 1, 7, 5, 9, 8, 4, 6, 10, 11, 13, 12, 14]
			]
